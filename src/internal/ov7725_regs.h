...
#define COM3_VFLIP                                                             \
  0x80 /* Vertical flip image ON/OFF selection                    */
#define COM3_MIRROR                                                            \
  0x40 /* Horizontal mirror image ON/OFF selection                */
#define COM3_SWAP_BR                                                           \
  0x20 /* Swap B/R output sequence in RGB output mode             */
#define COM3_SWAP_YUV                                                          \
  0x10 /* Swap Y/UV output sequence in YUV output mode            */
#define COM3_SWAP_MSB                                                          \
  0x08 /* Swap output MSB/LSB                                     */
#define COM3_TRI_CLOCK                                                         \
  0x04 /* Tri-state option for output clock at power-down period  */
#define COM3_TRI_DATA                                                          \
  0x02 /* Tri-state option for output data at power-down period   */
#define COM3_COLOR_BAR                                                         \
  0x01 /* Sensor color bar test pattern output enable             */
...
#define COM5_AFR                                                               \
  0x80 /* Auto frame rate control ON/OFF selection (night mode) */
...
#define COM6_AUTO_WINDOW                                                       \
  0x01 /* Auto window setting ON/OFF selection when format changes */
...
#define COM10_PCLK_MASK                                                        \
  0x20 /* PCLK output option: masked during horizontal blank  */
...
#define COM10_OUT_RANGE_10                                                     \
  0x00 /* Output data range: Data from [10] to [F0] (8 MSBs) */

#define REG16 0x16           /* Register 16 */
#define REG16_BIT_SHIFT 0x80 /* Bit shift test pattern options */
#define HSTART                                                                 \
  0x17 /* Horizontal Frame (HREF column) Start 8 MSBs (2 LSBs are at           \
          HREF[5:4]) */
#define HSIZE 0x18 /* Horizontal Sensor Size (2 LSBs are at HREF[1:0]) */
#define VSTART                                                                 \
  0x19             /* Vertical Frame (row) Start 8 MSBs (1 LSB is at HREF[6]) */
...
#define LAEC                                                                   \
  0x1F /* Fine AEC Value - defines exposure value less than one row period */
...
#define HOUTSIZE                                                               \
  0x29 /* Horizontal Data Output Size MSBs (2 LSBs at register EXHCH[1:0]) */
#define EXHCH 0x2A /* Dummy Pixel Insert MSB */
#define EXHCL 0x2B /* Dummy Pixel Insert LSB */
#define VOUTSIZE                                                               \
  0x2C /* Vertical Data Output Size MSBs (LSB at register EXHCH[2])       */
#define ADVFL                                                                  \
  0x2D /* LSB of Insert Dummy Rows in Vertical Sync (1 bit equals 1 row)  */
...
#define LC_CTR_RGB_COMP_1                                                      \
  0x00 /* R, G, and B channel compensation coefficient is set by LC_COEF       \
          (0x49) */
#define LC_CTR_RGB_COMP_3                                                      \
  0x04 /* R, G, and B channel compensation coefficient is set by registers     \
          LC_COEFB (0x4B), LC_COEF (0x49), and LC_COEFR (0x4C), respectively   \
          */
#define LC_CTR_EN 0x01 /* Lens correction enable */
#define LC_XC                                                                  \
  0x47 /* X Coordinate of Lens Correction Center Relative to Array Center */
#define LC_YC                                                                  \
  0x48 /* Y Coordinate of Lens Correction Center Relative to Array Center */
...
#define GAM1                                                                   \
  0x7E /* Gamma Curve 1st Segment Input End Point 0x04 Output Value */
#define GAM2                                                                   \
  0x7F /* Gamma Curve 2nd Segment Input End Point 0x08 Output Value */
#define GAM3                                                                   \
  0x80 /* Gamma Curve 3rd Segment Input End Point 0x10 Output Value */
#define GAM4                                                                   \
  0x81 /* Gamma Curve 4th Segment Input End Point 0x20 Output Value */
#define GAM5                                                                   \
  0x82 /* Gamma Curve 5th Segment Input End Point 0x28 Output Value */
#define GAM6                                                                   \
  0x83 /* Gamma Curve 6th Segment Input End Point 0x30 Output Value */
#define GAM7                                                                   \
  0x84 /* Gamma Curve 7th Segment Input End Point 0x38 Output Value */
#define GAM8                                                                   \
  0x85 /* Gamma Curve 8th Segment Input End Point 0x40 Output Value */
#define GAM9                                                                   \
  0x86 /* Gamma Curve 9th Segment Input End Point 0x48 Output Value */
#define GAM10                                                                  \
  0x87 /* Gamma Curve 10th Segment Input End Point 0x50 Output Value */
#define GAM11                                                                  \
  0x88 /* Gamma Curve 11th Segment Input End Point 0x60 Output Value */
#define GAM12                                                                  \
  0x89 /* Gamma Curve 12th Segment Input End Point 0x70 Output Value */
#define GAM13                                                                  \
  0x8A /* Gamma Curve 13th Segment Input End Point 0x90 Output Value */
#define GAM14                                                                  \
  0x8B /* Gamma Curve 14th Segment Input End Point 0xB0 Output Value */
#define GAM15                                                                  \
  0x8C /* Gamma Curve 15th Segment Input End Point 0xD0 Output Value */
...
#define DSPAUTO_EDGE_EN                                                        \
  0x20 /* Sharpness (edge enhancement) auto strength control */
#define DSPAUTO_UV_EN 0x10 /* UV adjust auto slope control */
#define DSPAUTO_SCAL0_EN                                                       \
  0x08 /* Auto scaling factor control (register SCAL0 (0xA0)) */
#define DSPAUTO_SCAL1_EN                                                       \
  0x04 /* Auto scaling factor control (registers SCAL1 (0xA1 and SCAL2         \
          (0xA2))*/
